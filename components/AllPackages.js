          ...
          {data ? (
            <div className='flex flex-wrap -m-4 AllPackages'>
              {data.allPackages.data.map(node => (
                <div
                  key={node._id}
                  className='p-4 xl:w-1/3 md:w-1/2 SinglePackage'
                >
                  <div className='rounded-lg bg-gray-900'>
                    <div className='relative z-10 p-4 rounded-lg shadow-xl'>
                      ...
                      <img
                        className='object-cover object-center my-6 rounded'
                        src={node.logo}
                        alt='content'
                      />
                      <div className=''>
                        <h3 className='font-mono text-xs uppercase font-light text-gray-400'>
                          {node.category}
                        </h3>
